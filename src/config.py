...
def parse_args(jupyter=True):
    parser = argparse.ArgumentParser(description="Pytorch implementation of GAN models.")

    parser.add_argument('--model', type=str, default='DCGAN', choices=['DCGAN','WGANGP'])
    parser.add_argument('--is_train', type=str, default='True')
    parser.add_argument('--dataroot', help='path to dataset')
    parser.add_argument('--dataset', type=str, default='stamp', choices=['mnist', 'fashion-mnist', 'cifar', 'stl10', 'stamp', 'stamp_reference'],
    ...
    parser.add_argument('--latent_dim', type=int, default=100, help='The number of dimensions of latent dimension.')
...
def check_args(args):
    ...
    if args.dataset == 'cifar' or args.dataset == 'stl10' or args.dataset == 'stamp':
        args.channels = 3
    else:
        args.channels = 1
